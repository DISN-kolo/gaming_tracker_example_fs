...
import { GamesListEntry } from '../games-list-entry/games-list-entry';
import { NewGamesListEntry } from '../new-games-list-entry/new-games-list-entry';

@Component({
  imports: [GamesListEntry, NewGamesListEntry],
